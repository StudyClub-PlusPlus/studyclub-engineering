...
## 관계
- 1 : N [IDENTITY](./IDENTITY.md)
- 세션 토큰은 [SESSION](./SESSION.md) (Redis 캐시 — DB 관계 없음)
- 1 : N [STUDY_APPLICATION](./STUDY_APPLICATION.md), [STUDY_PARTICIPANT](./STUDY_PARTICIPANT.md), [ATTENDANCE](./ATTENDANCE.md), [STUDY_REVIEW](./STUDY_REVIEW.md), [STUDY_BOOKMARK](./STUDY_BOOKMARK.md), [STUDY_PROPOSAL](./STUDY_PROPOSAL.md)

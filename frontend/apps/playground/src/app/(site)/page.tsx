...
const ENTRIES = [
  {
    href: '/proto/core/ko/onboarding?scenario=default',
    title: '회원가입 · 온보딩 (한국어)',
    body: '닉네임·시간대·약관 동의. 로그인부터 가입 완료까지, 기본 화면과 오류 상태를 확인합니다.',
  },
  {
    href: '/proto/core/en/onboarding?scenario=default',
    title: 'Sign-up · Onboarding (English)',
    body: 'Preview profile setup, searchable time zones, scrollable terms and signup states in English.',
  },
  {
    href: '/components',
    title: '컴포넌트 카탈로그',

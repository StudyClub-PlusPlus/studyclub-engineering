...
const RULES: { match: string[]; icon: LucideIcon; label: string; color: Duo }[] = [
  { match: ["ai · ml", "ai/ml", "ai", "ml", "머신러닝", "딥러닝", "llm", "논문", "kaggle", "캐글", "causal", "인과"], icon: Brain, label: "AI · ML", color: C.violet },
  { match: ["알고리즘", "algorithm", "leetcode", "리트코드", "neetcode", "코테"], icon: Puzzle, label: "ALGORITHM", color: C.blue },
  { match: ["데이터", "data", "sql", "db", "디비"], icon: Database, label: "DATA", color: C.teal },
  { match: ["기획", "pm", "프로덕트", "product", "그로스", "growth"], icon: Package, label: "기획 · PM", color: C.violet },
  { match: ["커리어", "career", "이력서", "resume", "인터뷰", "interview", "면접"], icon: MessagesSquare, label: "CAREER", color: C.amber },
  { match: ["비즈니스", "business", "아티클", "article", "시장", "산업"], icon: Briefcase, label: "BUSINESS", color: C.slate },
  { match: ["북클럽", "book", "독서", "리딩"], icon: BookOpen, label: "BOOK CLUB", color: C.amber },
  { match: ["어학", "언어", "language", "영어", "중국어", "독일어", "german", "english", "chinese"], icon: Languages, label: "LANGUAGE", color: C.emerald },
  { match: ["라이프스타일", "lifestyle", "습관", "habit", "회고", "retro", "네트워킹", "network", "커피챗", "밋업", "meetup"], icon: Sunrise, label: "LIFESTYLE", color: C.rose },
  // 아래 두 개는 포괄 항목 — 위에서 안 걸린 것만 받는다
  { match: ["소프트웨어 개발", "코딩", "coding", "개발", "dev", "프론트", "frontend", "백엔드", "backend", "클라우드", "cloud", "보안", "security", "react", "golang", "redis"], icon: Code2, label: "DEV", color: C.indigo },

...
public class MockParticipantHubDataProvider implements ParticipantHubDataProvider {
    ...
    private ParticipatingStudyCohortDetailResponse ongoingStudy() {
        return new ParticipatingStudyCohortDetailResponse(
                ...
                new UpcomingStudyMeeting(
                        1004L, 301L, 101L, "AI 논문 읽기", Instant.parse("2026-09-08T11:00:00Z")),
                List.of(
                        completedAttendance(
                                1001L, "2026-08-18T11:00:00Z", AttendanceStatus.PRESENT),
                        completedAttendance(
                                1002L, "2026-08-25T11:00:00Z", AttendanceStatus.PRESENT),
                        completedAttendance(1003L, "2026-09-01T11:00:00Z", AttendanceStatus.LATE),
                        new StudyMeetingAttendance(
                                1004L, Instant.parse("2026-09-08T11:00:00Z"), null, null, null)),
    ...
    private ParticipatingStudyCohortDetailResponse completedStudy() {
        return new ParticipatingStudyCohortDetailResponse(
                ...
                8,
                88,
                java.time.LocalDate.parse("2026-05-06"),
                null,
                List.of(
    ...
    private StudyMeetingAttendance completedAttendance(
            Long meetingId, String scheduledAt, AttendanceStatus status) {
        Instant scheduled = Instant.parse(scheduledAt);
        return new StudyMeetingAttendance(
                meetingId, scheduled, scheduled, scheduled.plusSeconds(5400), status);
    }
}

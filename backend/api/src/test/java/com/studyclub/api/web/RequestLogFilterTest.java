 ...
 *
 * <p>여기서 지키는 것 셋: (1) 식별자가 MDC 에 들어간다, (2) 요청이 끝나면 <b>반드시</b> 지워진다
 * — 스레드는 재사용되므로 안 지우면 다음 요청 로그에 남의 requestId 가 붙는다,
 * (3) 들어온 {@code X-Request-Id} 를 계승한다 — 프론트·게이트웨이가 붙인 것을 이어받는다.
 */

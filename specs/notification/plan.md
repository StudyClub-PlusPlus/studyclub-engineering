...
| 저장 | Notification, NotificationTemplate 및 JSON converter | 수신처·닉네임 스냅샷 보존 |
...
| 관리자 | RequireAdmin + AdminGuardInterceptor | 기존 온보딩 가드와 같은 구조, DB의 SYSTEM_ROLE 검사 |
...
- PR #80의 후속 요청 인가에 RequireAdmin/AdminGuardInterceptor를 재사용할 수 있다.
- PR #78 병합 시 principal 이메일 조회를 ACCOUNT.ID 조회로 맞춘다.

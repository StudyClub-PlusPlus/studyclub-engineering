...
- **작성 기준 확정**: 기수 단위 집계, 활성 크루의 범위, 온보딩 완료 회원 수, 시간대를 거주지로 간주하는 가정, 출석 계산 및 비교 기간, 마감 경과 표시, 행사 MVP 제외, 일부 지표 실패 시 정상 지표 유지.
...
| 이 문서에 포함한 기준 화면 및 작성자의 추가 결정(2026-09-16 및 후속 검토) | 활성·참여 정의, PAUSED 제외, 시간대 가정, 마감 경과, 주간 비교, 평균 계산, 행사 범위, 일부 지표 실패 시 정상 지표 유지 |
